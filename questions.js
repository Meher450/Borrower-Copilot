...
(function (root) {
  ...
  var MUST_QUESTIONS = [
    ...
    { id: "netIncome", label: "Net monthly income, take-home (₹)", type: "number" },
    { id: "existingEMIs", label: "Total existing monthly EMIs (₹, 0 if none)", type: "number" },
    { id: "householdExpenses", label: "Monthly household expenses, excluding EMIs (₹)", type: "number" },
